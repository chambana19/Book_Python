...
\begin{itemize}
\item[] \textbf{August 18, 2026}: Added Chapter 19 on gradient-based and metaheuristic optimization, Chapter 20 on classification and model selection, and Chapter 21 on neural networks, with companion scripts and generated figures.
...
\input{Chapters/14_GeoPandas_Foundations}
\input{Chapters/15_GeoDatasets_and_Applied_Mapping}

\part{Part VI: Algorithms, Optimization, and Machine Learning}
\input{Chapters/16_Algorithmic_Thinking_and_Efficiency}
\input{Chapters/17_Numerical_Optimization_with_SciPy}
\input{Chapters/18_Machine_Learning_Foundations}
\input{Chapters/19_Gradient_and_Metaheuristic_Optimization}
\input{Chapters/20_Classification_and_Model_Selection}
\input{Chapters/21_Neural_Networks}
