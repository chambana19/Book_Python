...
\providecommand{\BookSubtitle}{Programming Foundations, Algorithms, Data Analysis, Visualization, Geospatial Computing, Optimization, and Machine Learning}
...
\vfill
\begin{center}
  \accessibleimage{width=.3\textwidth,height=.45\textheight,keepaspectratio}{Figures/Program symbol.pdf}{Abstract program symbol connecting code, design, and computation}
