...
\code{c13_import_matplotlib}{python}{
    ...
    plt.close(fig)
}{Create and close an empty figure}
...
\code{c13_line_plot}{python}{
    ...
    plt.show()
    plt.close(fig)
}{Show ordered change with a line}
...
\code{c13_two_lines}{python}{
    ...
    plt.show()
    plt.close(fig)
}{Compare two series with redundant visual cues}
...
\code{c13_bar_chart}{python}{
    ...
    plt.show()
    plt.close(fig)
}{Compare category values with bars}
...
\code{c13_horizontal_bar}{python}{
    import matplotlib.pyplot as plt
    ...
    plt.show()
    plt.close(fig)
}{Use horizontal bars for readable category labels}
...
\code{c13_scatter_plot}{python}{
    ...
    plt.show()
    plt.close(fig)
}{Show a relationship between two numerical variables}
...
\code{c13_histogram}{python}{
    ...
    plt.show()
    plt.close(fig)
}{Group numerical values into histogram bins}
...
\code{c13_plot_dataframe}{python}{
    import matplotlib.pyplot as plt
    import pandas as pd
    ...
    plt.show()
    plt.close(fig)
}{Prepare pandas data before plotting}
...
\code{c13_two_subplots}{python}{
    ...
    plt.show()
    plt.close(fig)
}{Place two related questions in one Figure}
...
\code{c13_annotation}{python}{
    ...
    plt.show()
    plt.close(fig)
}{Annotate one observation without crowding the plot}
...
}{Save a labeled figure to a folder}
...
\code{c13_practice_level0}{python}{
    import matplotlib.pyplot as plt
...
\code{c13_practice_level1}{python}{
    ...
    plt.show()
    plt.close(fig)
}{Complete the communication around a bar chart}
...
\textbf{Hints}
\begin{itemize}
    \item Create the Figure with \c{plt.subplots(1, 2)}.
    \item Select DataFrame columns by name.
    \item Give each Axes its own title and labels.
\end{itemize}
...
\code{c13_solution_level2}{python}{
    import matplotlib.pyplot as plt
...
\code{c13_solution_level3}{python}{
    import matplotlib.pyplot as plt
    import pandas as pd
...
\code{c13_solution_level4}{python}{
    import matplotlib.pyplot as plt
