...
\begin{itemize}
    ...
    \item \textbf{Go deeper into search and modeling:}
          \booklink{ch:19}{gradient-based and metaheuristic optimization},
          \booklink{ch:20}{classification and model selection}, and
          \booklink{ch:21}{neural networks}.
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
    ...
    \item Benchmark gradient descent against three metaheuristics in the
          \booklink{sec:c19-application}{facade design application}, select
          a model without spending the test set in the
          \booklink{sec:c20-application}{comfort-complaint triage}, and build a
          network from arrays in the
          \booklink{sec:c21-application}{neural-network application}.
\end{itemize}
