...
\providecommand{\ImprintCopyrightYears}{2024--2026}
...
\vspace{1.2\baselineskip}
\textbf{Accessibility:} This edition uses descriptive figure captions,
visible hyperlinks, document-language metadata, and a logical heading
structure. The standard build intentionally leaves experimental structural
PDF tagging disabled until the LaTeX tagging toolchain reliably supports the
book's code-listing and boxed teaching environments.\par
