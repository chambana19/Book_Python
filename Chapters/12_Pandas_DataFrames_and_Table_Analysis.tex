...
pandas is an external library. If you are using Spyder, it is already
...
\begin{lstlisting}[
    language=bash,
    style=block,
    caption={Install pandas from a terminal, not inside a Python file},
    label={c12_install_pandas},
    captionpos=b
]
