...
For an area function, a reasonable contract is: accept two nonnegative numeric
dimensions and return their product as an area without printing or changing
the inputs. The formula is only one part of the design; the contract explains
