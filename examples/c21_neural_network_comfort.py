...
network then takes its turn as one candidate in the Chapter 20 workflow, where
...
# 1. Reuse the Chapter 20 dataset so the comparison is direct.
...
# 3. Prepare the data exactly as Chapter 20 did.
